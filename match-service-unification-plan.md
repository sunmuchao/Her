...
当前系统最大的问题，不是同时用了 MySQL 和 SQLite，而是：
...
- MySQL：用户核心资料、画像、公开视图
- 推荐系统 SQLite：推荐、卡片、用户动作、代理转介绍 case
- 撮合系统 SQLite：pool、edge、pair、case、反馈回流
