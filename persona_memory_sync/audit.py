...
from .cli import run_ensure_schema
...
DEFAULT_PERSONAS_FILE = REPO_ROOT / "local-skills" / "persona-memory-sync" / "references" / "audit_personas.json"
...
def ensure_schema(source: str) -> None:
    run_ensure_schema(source=source)
