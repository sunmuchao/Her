...
- [推荐来信已读状态修复总结](recommendation-read-state-fix-summary.md) — 2026-06-25：修复推荐来信点击卡片后红色提醒和图标数字不更新的问题（事件机制+徽章监听）
...
- [JSON 序列化错误修复](json-serialization-error-fix.md) — 2026-06-23：修复 search_partner_candidates 工具的 set → list 转换问题
...
- [推荐来信已读状态测试场景](recommendation-read-state-test-scenarios.md) — 推荐来信已读状态完整测试场景设计（功能正确性、事件机制、徽章计数、边缘场景、性能、跨页面同步、数据一致性）
