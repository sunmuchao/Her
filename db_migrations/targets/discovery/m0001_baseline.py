"""Baseline discovery schema migration."""
...
MIGRATION = baseline_migration(
    description="Baseline discovery schema",
    scope_fn=default_scope,
    apply_fn=apply_system_schema(_schema.discovery_tables()),
    validate_fn=validate_system_schema(_schema.discovery_tables()),
)
