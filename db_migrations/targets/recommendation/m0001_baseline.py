"""Baseline recommendation schema migration."""
...
MIGRATION = baseline_migration(
    ...
    apply_fn=apply_system_schema(_schema.recommendation_tables()),
    validate_fn=validate_system_schema(_schema.recommendation_tables()),
)
