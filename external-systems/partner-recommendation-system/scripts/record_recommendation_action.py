...
"""Record an outer-system recommendation action such as skip/save/direct_greet."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Record a saved-search recommendation action.")
    parser.add_argument(
        "--db",
