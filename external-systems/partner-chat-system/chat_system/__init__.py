...
_EXPORT_MODULES = {
    ...
    "VIS_SYSTEM": ".service",
    "CALL_STATUS_ACTIVE": ".call_sessions",
    "CALL_STATUS_ENDED": ".call_sessions",
    "CALL_STATUS_PENDING": ".call_sessions",
    "CALL_TYPE_AUDIO": ".call_sessions",
    "CALL_TYPE_VIDEO": ".call_sessions",
    ...
    "create_call_session": ".call_sessions",
    ...
    "end_call_session": ".call_sessions",
    ...
    "get_call_session_by_case": ".call_sessions",
    ...
    "list_call_sessions_by_case": ".call_sessions",
    ...
    "upsert_phone_role_binding": ".auth_accounts",
    ...
    "update_call_status": ".call_sessions",
    ...
    "upload_image": ".media_storage",
    "get_media_url": ".media_storage",
    "delete_media": ".media_storage",
    "check_minio_health": ".media_storage",
}
