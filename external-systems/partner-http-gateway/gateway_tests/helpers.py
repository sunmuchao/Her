...
CREATE TABLE `profiles` (
  ...
  `preferred_education_min` VARCHAR(64),
  `preferred_income_min_wan` INT,
  `preferred_income_max_wan` INT,
  `accept_marital_status` TEXT,
  `accept_marital_status_strength` VARCHAR(32),
  `accept_partner_children` VARCHAR(16),
  `accept_partner_children_strength` VARCHAR(32),
  `accept_partner_children_semantics` VARCHAR(128),
  `accept_long_distance` VARCHAR(16),
  `location_preference_semantics` VARCHAR(128),
  `requires_partner_accept_my_children` TINYINT(1),
  `personality` TEXT,
  `public_display_name` VARCHAR(64),
  `public_education` VARCHAR(32),
  `public_job` VARCHAR(64),
  `public_personality` TEXT,
  `public_values` TEXT,
  `public_notes` TEXT,
  `matcher_traits_json` JSON,
  `matcher_preferences_json` JSON,
  `matcher_risks_json` JSON,
  `matcher_summary_internal` TEXT,
  `values` TEXT,
  `notes` TEXT,
