"""Auth storage: user accounts, sessions, OTP challenges, etc."""
...
DEFAULT_AUTH_MYSQL_DSN = os.environ.get(
    "HER_AUTH_DB", "mysql://root@127.0.0.1:3307/her_auth"
)
...
connect_db, initialize_database, reset_all_tables = build_external_storage_helpers(
    subsystem_name="auth",
    target="auth",
    table_names=schema_table_names("auth"),
    default_dsn=DEFAULT_AUTH_MYSQL_DSN,
)
