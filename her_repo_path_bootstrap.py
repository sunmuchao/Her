...
_PARTNER_SYSTEM_DIRS = (
    ...
    Path("external-systems/auth-system"),
    Path("external-systems/verification-system"),
    Path("external-systems/risk-system"),
    Path("external-systems/infrastructure-system"),
)
